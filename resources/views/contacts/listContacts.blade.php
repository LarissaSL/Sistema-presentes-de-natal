        ...
        <div class="row justify-content-center">
            <div class="col">
                ...
                @if (session('success'))
                    ...
                    <div class="alert alert-success d-flex align-items-center justify-content-between w-50 mx-auto"
                        role="alert">
                        <div class="d-flex">
            ...
            @else
                ...
                @if ($errors->any())
                    <div class="alert alert-warning d-flex align-items-center w-50 mx-auto mt-3" role="alert">
